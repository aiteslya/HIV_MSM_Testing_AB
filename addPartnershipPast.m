function all_partnerships = addPartnershipPast(all_partnerships, i, j, start_date, end_date)
    

    % Check if partnership already exists
%     if partnershipExistsPast(all_partnerships, i, j, start_date) || partnershipExistsPast(all_partnerships, j, i, start_date)
